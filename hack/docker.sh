...
# Examples:
#   hack/docker.sh multicluster-provider-fake
#   BUILD_PLATFORMS=linux/amd64 hack/docker.sh multicluster-provider-fake
#   OUTPUT_TYPE=registry BUILD_PLATFORMS=linux/amd64,linux/arm64 hack/docker.sh multicluster-provider-fake
#   DOCKER_BUILD_ARGS="--build-arg https_proxy=${https_proxy}" hack/docker.sh multicluster-provider-fake
